package com.marriott.rfp.business.pricing.edie.api;
...
public interface EdieService {
    ...
    public void updateEdieColumnDescription(List<EdieColumnsUpdate> edieColumnList);
