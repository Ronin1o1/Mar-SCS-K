package com.marriott.rfp.dataacess.pricing.audittrail.impl;
...
/**
 * Insert the type's description here. Creation date: (3/18/02 5:59:45 PM)
 * 
 * @author:
 */
public class AuditUtilityManagerImpl {
	...
	queryString = "select sid  from v$mystat where statistic# = 0";
