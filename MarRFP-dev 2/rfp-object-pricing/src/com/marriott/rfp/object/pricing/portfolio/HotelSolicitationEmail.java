...
public class HotelSolicitationEmail implements Serializable {
	...
	// Shared account Leader//
	private String sharedContact;
	private String sharedContactEmail;
	
	public String getSharedContact() {
		return sharedContact;
	}
	public void setSharedContact(String sharedContact) {
		this.sharedContact = sharedContact;
	}

	public String getSharedContactEmail() {
		return sharedContactEmail;
	}
	public void setSharedContactEmail(String sharedContactEmail) {
		this.sharedContactEmail = sharedContactEmail;
	}
