...
public class SetRateProductDisplayTextNotifBindingStub extends org.apache.axis.client.Stub implements SetRateProductDisplayTextNotifPortType {
	private Vector cachedSerClasses = new Vector();
    private Vector cachedSerQNames = new Vector();
    private Vector cachedSerFactories = new Vector();
    private Vector cachedDeserFactories = new Vector();

    public SetRateProductDisplayTextNotifBindingStub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public SetRateProductDisplayTextNotifBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public SetRateProductDisplayTextNotifBindingStub(javax.xml.rpc.Service service) throws AxisFault {
        if (service == null) {
        ...
        qName = new QName("", ">MI_RateProductDisplayTextNotifRS");
        cachedSerQNames.add(qName);
        cls = MI_RateProductDisplayTextNotifRS.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);

        qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_RateProductDisplayTextNotifRS");
        cachedSerQNames.add(qName);
        cls = MI_RateProductDisplayTextNotifRS.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        ...
        qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_RateProductDisplayTextNotifRQ");
        cachedSerQNames.add(qName);
        cls = MI_RateProductDisplayTextNotifRQ.class;
        cachedSerClasses.add(cls);
    ...
    public MI_RateProductDisplayTextNotifRS MI_RateProductDisplayTextNotifRQ(
            MI_RateProductDisplayTextNotifRQ MI_RateProductDisplayTextNotifRQ,String SoapPort_address)
            throws RemoteException, ServiceException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        Call _call = createCall();
        _call.addParameter(new QName("http://www.opentravel.org/OTA/2003/05", "MI_RateProductDisplayTextNotifRQ"), new QName(
                "http://www.opentravel.org/OTA/2003/05", ">MI_RateProductDisplayTextNotifRQ"),
                MI_RateProductDisplayTextNotifRQ.class, ParameterMode.IN);
        _call.setReturnType(new QName("http://www.opentravel.org/OTA/2003/05", ">MI_RateProductDisplayTextNotifRS"),
                MI_RateProductDisplayTextNotifRS.class);
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("MI_RateProductDisplayTextNotifRQ");
        _call.setEncodingStyle(UriLiteralConstant.URI_LITERAL_ENC);
        _call.setOperationStyle("document");
        _call.setOperationName(new QName("http://www.opentravel.org/OTA/2003/05", "MI_RateProductDisplayTextNotifRQ"));

        java.lang.Object _resp;
        try {
            _resp = _call.invoke(new Object[] { MI_RateProductDisplayTextNotifRQ });
            if (_resp instanceof java.rmi.RemoteException) {
                throw (java.rmi.RemoteException) _resp;
            } else {
                try {
                    return (MI_RateProductDisplayTextNotifRS) _resp;
                } catch (Exception _exception) {
                    return (MI_RateProductDisplayTextNotifRS) JavaUtils.convert(_resp,
                            MI_RateProductDisplayTextNotifRS.class);
                }
            }
        } catch (Exception e) {
    ...
    public MI_RateProductDisplayTextNotifRS UpdateDisplayText(MI_RateProductDisplayTextRS roomproductInfo, String loginName,String SoapPort_address) throws RemoteException,
            ServiceException {
        return MI_RateProductDisplayTextNotifRQ(GetUpdateRequestMessage(roomproductInfo, loginName),SoapPort_address);

    }

    private MI_RateProductDisplayTextNotifRQ GetUpdateRequestMessage(MI_RateProductDisplayTextRS roomproductInfo, String loginName) {
        //both marshacode and roompool must be present
        MI_RateProductDisplayTextNotifRQ req_msg = new MI_RateProductDisplayTextNotifRQ();
        ...
        req_msg.setBrandsList(roomproductInfo.getBrandsList());
        req_msg.setRateProductDefinitions(roomproductInfo.getRateProductDefinitions());
        return req_msg;
    }
