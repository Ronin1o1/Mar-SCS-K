...
public class GetHotelAmenityListsInfoBindingStub extends org.apache.axis.client.Stub implements GetHotelAmenityListsInfoPortType {
	private Vector cachedSerClasses = new Vector();
	private Vector cachedSerQNames = new Vector();
	private Vector cachedSerFactories = new Vector();
	private Vector cachedDeserFactories = new Vector();

	public GetHotelAmenityListsInfoBindingStub() throws org.apache.axis.AxisFault {
		this(null);
	}

	public GetHotelAmenityListsInfoBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public GetHotelAmenityListsInfoBindingStub(javax.xml.rpc.Service service) throws AxisFault {
		if (service == null) {
		...
		qName = new QName("", ">MI_HotelAmenityListsInfoRS");
		cachedSerQNames.add(qName);
		cls = MI_HotelAmenityListsInfoRS.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);

		qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelAmenityListsInfoRS");
		cachedSerQNames.add(qName);
		cls = MI_HotelAmenityListsInfoRS.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		...
		qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelAmenityListsInfoRQ");
		cachedSerQNames.add(qName);
		cls = MI_HotelAmenityListsInfoRQ.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
		...
		qName = new QName("http://www.opentravel.org/OTA/2003/05", ">FormatsList");
		cachedSerQNames.add(qName);
		cls = FormatsList.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
	...
	public MI_HotelAmenityListsInfoRS MI_HotelAmenityListsRQ(MI_HotelAmenityListsInfoRQ MI_HotelAmenityListsRQ,String SoapPort_address) throws RemoteException, ServiceException {
		if (super.cachedEndpoint == null) {
			throw new org.apache.axis.NoEndPointException();
		}
		Call _call = createCall();
		_call.addParameter(
			new QName("http://www.opentravel.org/OTA/2003/05", "MI_HotelAmenityListsInfoRQ"),
			new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelAmenityListsInfoRQ"),
			MI_HotelAmenityListsInfoRQ.class,
			ParameterMode.IN);
		_call.setReturnType(new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelAmenityListsInfoRS"), MI_HotelAmenityListsInfoRS.class);
		_call.setUseSOAPAction(true);
		_call.setSOAPActionURI("GetHotelAmenityLists");
		_call.setEncodingStyle(UriLiteralConstant.URI_LITERAL_ENC);
		_call.setOperationStyle("document");
		_call.setOperationName(new QName("http://www.opentravel.org/OTA/2003/05", "MI_HotelAmenityListsInfoRQ"));

		java.lang.Object _resp;
		try {
			_resp = _call.invoke(new Object[] { MI_HotelAmenityListsRQ });
			if (_resp instanceof java.rmi.RemoteException) {
				throw (java.rmi.RemoteException) _resp;
			} else {
				try {
					return (MI_HotelAmenityListsInfoRS) _resp;
				} catch (Exception _exception) {
					return (MI_HotelAmenityListsInfoRS) JavaUtils.convert(_resp, MI_HotelAmenityListsInfoRS.class);
				}
			}
		} catch (Exception e) {
			throw new ServiceException("Amenity List Not Found");
			
		}
		
	}

	public MI_HotelAmenityListsInfoRS MI_HotelAmenityListsRQ(String SoapPort_address) throws RemoteException, ServiceException {
		return MI_HotelAmenityListsRQ(GetRequestMessage(),SoapPort_address);

	}

	private MI_HotelAmenityListsInfoRQ GetRequestMessage( ){
		//both marshacode and roompool must be present
		MI_HotelAmenityListsInfoRQ req_msg = new MI_HotelAmenityListsInfoRQ();
		req_msg.setEchoToken("A");
		req_msg.setVersion("1.0");

		RequestorID r_id = new RequestorID();
		r_id.setID("KORAMENITYLISTS");
		Source s = new Source();
