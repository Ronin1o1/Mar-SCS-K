...
public class GetHotelRoomProductDisplayTextBindingStub extends org.apache.axis.client.Stub implements GetHotelRoomProductDisplayTextPortType {
	private Vector cachedSerClasses = new Vector();
	private Vector cachedSerQNames = new Vector();
	private Vector cachedSerFactories = new Vector();
	private Vector cachedDeserFactories = new Vector();

	public GetHotelRoomProductDisplayTextBindingStub() throws org.apache.axis.AxisFault {
		this(null);
	}

	public GetHotelRoomProductDisplayTextBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public GetHotelRoomProductDisplayTextBindingStub(javax.xml.rpc.Service service) throws AxisFault {
		if (service == null) {
		...
		qName = new QName("", ">MI_HotelRoomProductDisplayTextRS");
		cachedSerQNames.add(qName);
		cls = MI_HotelRoomProductDisplayTextRS.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);

		qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelRoomProductDisplayTextRS");
		cachedSerQNames.add(qName);
		cls = MI_HotelRoomProductDisplayTextRS.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		...
		qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelRoomProductDisplayTextRQ");
		
		cachedSerQNames.add(qName);
		cls = MI_HotelRoomProductDisplayTextRQ.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
	...
	public MI_HotelRoomProductDisplayTextRS MI_HotelRoomProductDisplayTextRQ(MI_HotelRoomProductDisplayTextRQ MI_HotelRoomProductDisplayTextRQ,String SoapPort_address) throws RemoteException, ServiceException {
		if (super.cachedEndpoint == null) {
			throw new org.apache.axis.NoEndPointException();
		}
		Call _call = createCall();
		_call.addParameter(
			new QName("http://www.opentravel.org/OTA/2003/05", "MI_HotelRoomProductDisplayTextRQ"),
			new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelRoomProductDisplayTextRQ"),
			MI_HotelRoomProductDisplayTextRQ.class,
			ParameterMode.IN);
		_call.setReturnType(new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelRoomProductDisplayTextRS"), MI_HotelRoomProductDisplayTextRS.class);
		_call.setUseSOAPAction(true);
		_call.setSOAPActionURI("GetHotelRoomProductDisplayText");
		_call.setEncodingStyle(UriLiteralConstant.URI_LITERAL_ENC);
		//_call.setEncodingStyle("UTF-8");
		_call.setOperationStyle("document");
		_call.setOperationName(new QName("http://www.opentravel.org/OTA/2003/05", "MI_HotelRoomProductDisplayTextRQ"));

		java.lang.Object _resp;
		try {
			_resp = _call.invoke(new Object[] { MI_HotelRoomProductDisplayTextRQ });
			if (_resp instanceof java.rmi.RemoteException) {
				throw (java.rmi.RemoteException) _resp;
			} else {
				try {
					return (MI_HotelRoomProductDisplayTextRS) _resp;
				} catch (Exception _exception) {
					return (MI_HotelRoomProductDisplayTextRS) JavaUtils.convert(_resp, MI_HotelRoomProductDisplayTextRS.class);
				}
			}
		} catch (Exception e) {
	...
	public MI_HotelRoomProductDisplayTextRS MI_HotelRoomProductDisplayTextRQ(Channel channel, String langId,String SoapPort_address) throws RemoteException, ServiceException {
		return MI_HotelRoomProductDisplayTextRQ(GetRequestMessage(channel, langId), SoapPort_address);

	}

	private MI_HotelRoomProductDisplayTextRQ GetRequestMessage(Channel channel, String langId) {
		MI_HotelRoomProductDisplayTextRQ req_msg = new MI_HotelRoomProductDisplayTextRQ();
