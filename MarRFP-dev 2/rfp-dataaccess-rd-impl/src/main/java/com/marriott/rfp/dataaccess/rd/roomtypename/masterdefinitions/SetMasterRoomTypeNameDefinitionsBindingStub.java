...
public class SetMasterRoomTypeNameDefinitionsBindingStub extends org.apache.axis.client.Stub implements SetMasterRoomTypeNameDefinitionsPortType {
    ...
    public SetMasterRoomTypeNameDefinitionsBindingStub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public SetMasterRoomTypeNameDefinitionsBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public SetMasterRoomTypeNameDefinitionsBindingStub(javax.xml.rpc.Service service) throws AxisFault {
        if (service == null) {
        ...
        qName = new QName("", ">MI_MasterRoomTypeNameDefinitionsNotifRS");
        cachedSerQNames.add(qName);
        cls = MI_MasterRoomTypeNameDefinitionsNotifRS.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);

        qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_MasterRoomTypeNameDefinitionsNotifRS");
        cachedSerQNames.add(qName);
        cls = MI_MasterRoomTypeNameDefinitionsNotifRS.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        ...
        qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_MasterRoomTypeNameDefinitionsNotifRQ");
        cachedSerQNames.add(qName);
        cls = MI_MasterRoomTypeNameDefinitionsNotifRQ.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
    ...
    public MI_MasterRoomTypeNameDefinitionsNotifRS MI_MasterRoomTypeNameDefinitionsNotifRQ(
            MI_MasterRoomTypeNameDefinitionsNotifRQ MI_MasterRoomTypeNameDefinitionsNotifRQ,String SoapPort_address) throws RemoteException,
            ServiceException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        Call _call = createCall();
        _call.addParameter(new QName("http://www.opentravel.org/OTA/2003/05", "MI_MasterRoomTypeNameDefinitionsNotifRQ"), new QName(
                "http://www.opentravel.org/OTA/2003/05", ">MI_MasterRoomTypeNameDefinitionsNotifRQ"),
                MI_MasterRoomTypeNameDefinitionsNotifRQ.class, ParameterMode.IN);
        _call.setReturnType(new QName("http://www.opentravel.org/OTA/2003/05", ">MI_MasterRoomTypeNameDefinitionsNotifRS"),
                MI_MasterRoomTypeNameDefinitionsNotifRS.class);
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("SetMasterRoomTypeNameDefinitions");
        _call.setEncodingStyle(UriLiteralConstant.URI_LITERAL_ENC);
        _call.setOperationStyle("document");
        _call.setOperationName(new QName("http://www.opentravel.org/OTA/2003/05", "MI_MasterRoomTypeNameDefinitionsNotifRQ"));

        java.lang.Object _resp;
        try {
            _resp = _call.invoke(new Object[] { MI_MasterRoomTypeNameDefinitionsNotifRQ });
            if (_resp instanceof java.rmi.RemoteException) {
                throw (java.rmi.RemoteException) _resp;
            } else {
                try {
                    return (MI_MasterRoomTypeNameDefinitionsNotifRS) _resp;
                } catch (Exception _exception) {
                    return (MI_MasterRoomTypeNameDefinitionsNotifRS) JavaUtils.convert(_resp,
                            MI_MasterRoomTypeNameDefinitionsNotifRS.class);
                }
            }
        } catch (Exception e) {
            throw new ServiceException("Set RoomTypeName Definition Exception");
        }
    }

    public MI_MasterRoomTypeNameDefinitionsNotifRS MI_MasterRoomTypeNameDefinitionsNotifRQ(
            RoomTypeNameDefinitions roomtypenameinfo, String loginName,String SoapPort_address) throws RemoteException,
            ServiceException {
        return MI_MasterRoomTypeNameDefinitionsNotifRQ(GetRequestMessage(roomtypenameinfo, loginName),SoapPort_address);

    }

    private MI_MasterRoomTypeNameDefinitionsNotifRQ GetRequestMessage( RoomTypeNameDefinitions roomtypenameinfo,
            String loginName) {
        MI_MasterRoomTypeNameDefinitionsNotifRQ req_msg = new MI_MasterRoomTypeNameDefinitionsNotifRQ();
