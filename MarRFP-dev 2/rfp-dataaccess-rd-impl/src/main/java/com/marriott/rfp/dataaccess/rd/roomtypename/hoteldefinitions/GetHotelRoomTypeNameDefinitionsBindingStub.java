...
public class GetHotelRoomTypeNameDefinitionsBindingStub extends org.apache.axis.client.Stub implements GetHotelRoomTypeNameDefinitionsPortType {
	private Vector cachedSerClasses = new Vector();
	private Vector cachedSerQNames = new Vector();
	private Vector cachedSerFactories = new Vector();
	private Vector cachedDeserFactories = new Vector();

	public GetHotelRoomTypeNameDefinitionsBindingStub() throws org.apache.axis.AxisFault {
		this(null);
	}

	public GetHotelRoomTypeNameDefinitionsBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public GetHotelRoomTypeNameDefinitionsBindingStub(javax.xml.rpc.Service service) throws AxisFault {
		if (service == null) {
		...
		qName = new QName("", ">MI_HotelRoomTypeNameDefinitionsRS");
		cachedSerQNames.add(qName);
		cls = MI_HotelRoomTypeNameDefinitionsRS.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);

		qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelRoomTypeNameDefinitionsRS");
		cachedSerQNames.add(qName);
		cls = MI_HotelRoomTypeNameDefinitionsRS.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		...
		qName = new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelRoomTypeNameDefinitionsRQ");
		cachedSerQNames.add(qName);
		cls = MI_HotelRoomTypeNameDefinitionsRQ.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
	...
	public MI_HotelRoomTypeNameDefinitionsRS MI_HotelRoomTypeNameDefinitionsRQ(MI_HotelRoomTypeNameDefinitionsRQ MI_HotelRoomTypeNameDefinitionsRQ,String SoapPort_address) throws RemoteException, ServiceException {
		if (super.cachedEndpoint == null) {
			throw new org.apache.axis.NoEndPointException();
		}
		Call _call = createCall();
		_call.addParameter(
			new QName("http://www.opentravel.org/OTA/2003/05", "MI_HotelRoomTypeNameDefinitionsRQ"),
			new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelRoomTypeNameDefinitionsRQ"),
			MI_HotelRoomTypeNameDefinitionsRQ.class,
			ParameterMode.IN);
		_call.setReturnType(new QName("http://www.opentravel.org/OTA/2003/05", ">MI_HotelRoomTypeNameDefinitionsRS"), MI_HotelRoomTypeNameDefinitionsRS.class);
		_call.setUseSOAPAction(true);
		_call.setSOAPActionURI("GetHotelRoomTypeNameDefinitions");
		_call.setEncodingStyle(UriLiteralConstant.URI_LITERAL_ENC);
		_call.setOperationStyle("document");
		_call.setOperationName(new QName("http://www.opentravel.org/OTA/2003/05", "MI_HotelRoomTypeNameDefinitionsRQ"));

		java.lang.Object _resp;
		try {
			_resp = _call.invoke(new Object[] { MI_HotelRoomTypeNameDefinitionsRQ });
			if (_resp instanceof java.rmi.RemoteException) {
				throw (java.rmi.RemoteException) _resp;
			} else {
				try {
					return (MI_HotelRoomTypeNameDefinitionsRS) _resp;
				} catch (Exception _exception) {
					return (MI_HotelRoomTypeNameDefinitionsRS) JavaUtils.convert(_resp, MI_HotelRoomTypeNameDefinitionsRS.class);
				}
			}
		} catch (Exception e) {
	...
	public MI_HotelRoomTypeNameDefinitionsRS MI_HotelRoomTypeNameDefinitionsRQ(String marshacode, String roompool,String SoapPort_address) throws RemoteException, ServiceException {
		return MI_HotelRoomTypeNameDefinitionsRQ(GetRequestMessage(marshacode, roompool),SoapPort_address);

	}

	private MI_HotelRoomTypeNameDefinitionsRQ GetRequestMessage(String marshacode, String roompool) {
		MI_HotelRoomTypeNameDefinitionsRQ req_msg = new MI_HotelRoomTypeNameDefinitionsRQ();
