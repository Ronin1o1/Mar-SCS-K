...
@RestController
@RequestMapping("/cbcrequestfindfilter")

public class CBCRequestFindFilterController extends BaseFindFilterController {

    private static final Logger log = LoggerFactory.getLogger(CBCRequestFindFilterController.class);
    public CBCRequestFindFilterController() {
        super();
    }

    @RequestMapping(value = "/getCBCRequestFindFilter", method = GET)
    public String getCBCRequestFindFilter() {
