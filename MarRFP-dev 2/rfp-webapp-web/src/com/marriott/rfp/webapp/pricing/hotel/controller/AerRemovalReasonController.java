...
@RestController
@RequestMapping("/hotelaerremovalreason")
public class AerRemovalReasonController extends BaseController {

    private static final Logger log = LoggerFactory.getLogger(AerRemovalReasonController.class);
    @Autowired
    private HotelRFPAccountSpecificService hotelRFPAccountSpecificService = null;

    public AerRemovalReasonController() {
        super();
    }

    @Autowired
    public AerRemovalReasonController(HotelRFPAccountSpecificService hotelRFPAccountSpecificService) {
        super();
        this.setHotelRFPAccountSpecificService(hotelRFPAccountSpecificService);
    }

    @RequestMapping(value = "/getRemovalReason", method = RequestMethod.GET)
