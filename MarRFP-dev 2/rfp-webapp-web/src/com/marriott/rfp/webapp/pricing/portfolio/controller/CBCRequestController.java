...
@RestController
@RequestMapping("/cbcrequest")
public class CBCRequestController extends BaseDoubleFilterController {

    private static final Logger log = LoggerFactory.getLogger(CBCRequestController.class);
    public CBCRequestController() {
        super();

    }

    @Autowired
    public CBCRequestController(PricingFilterListsService pricingFilterListsService) {
        super(pricingFilterListsService);
    }

    @RequestMapping(value = "/getCBCRequestPricingFilter", method = GET)
    public String getCBCRequestPricingFilter() {
        try {
            ...
            //setTopList("/cbcrequestavail/view.action");//Upgrade-revisit
            //setBottomList("/cbcrequestselect/view.action");
            //setFindFilterAction("/cbcrequestfindfilter/view.action");
