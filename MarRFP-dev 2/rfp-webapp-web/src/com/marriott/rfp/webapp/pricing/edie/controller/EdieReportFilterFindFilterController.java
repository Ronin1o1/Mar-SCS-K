...
@RestController
@RequestMapping("/ediereportfilterfindfilter")
public class EdieReportFilterFindFilterController extends BaseFindFilterController {

    private static final Logger log = LoggerFactory.getLogger(EdieReportFilterFindFilterController.class);

    public EdieReportFilterFindFilterController() {
        super();
    }

    @RequestMapping(value = "/getEdieReportFindFilter", method = GET)
    public String getEdieReportFindFilter() {
