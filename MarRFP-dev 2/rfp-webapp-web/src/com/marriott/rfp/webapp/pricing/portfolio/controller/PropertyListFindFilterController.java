...
@RestController
@RequestMapping("/propertylistfindfilter")
public class PropertyListFindFilterController extends BaseFindFilterController {

    private static final Logger log = LoggerFactory.getLogger(PropertyListFindFilterController.class);
    public PropertyListFindFilterController() {
        super();
    }

    @RequestMapping(value = "/getPropertyListFindFilter", method = GET)
    public String getPropertyListFindFilter() throws Exception {
        try {
