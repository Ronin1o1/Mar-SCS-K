...
@RestController
@RequestMapping("/portfoliorebidfindfilter")

public class PortfolioRebidFindFilterController extends BaseFindFilterController {
    private static final Logger log = LoggerFactory.getLogger(PortfolioRebidFindFilterController.class);

    public PortfolioRebidFindFilterController() {
        super();
    }

    @RequestMapping(value = "/getPortfolioRebidFindFilter", method = GET)
    public String getPortfolioRebidFindFilter() {
