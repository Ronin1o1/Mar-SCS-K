...
@RestController()
@RequestMapping("/useredithotelaccess")
public class UserEditHotelAccessController extends UserEditController {

	public UserEditHotelAccessController() {
		super();
		//setShowProperties(true);
		//setShowAccounts(false);
		String returnnamespace ="/userhotelaccess";
	}
	@RequestMapping(value = "/getUserEditHotelAccess",method = {GET,POST})
	public String  getUserEditHotelAccess(String franchise,String role, Boolean showProperties,String optSel,Boolean showAccounts,boolean showManaged,Long userid,String strCurrPagePropSel,String alphaOrderProp,String filterByMorF,String alphaOrderAcct,String accountpricingtype,String accountsegment,String strCurrPageProp,String strCurrPageAcctSel,String strCurrPageAcct,Long totPropSelPageLen)  throws Exception {
