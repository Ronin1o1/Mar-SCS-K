...
const APIEdit = {
  async populatePropertyList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.populateProperty)}`,
      postData,
      {
        headers: {
  ...
  async updatePropertyList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.updateProperty)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async deletePropertyList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.deleteProperty)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async searchAvailPropList(userDetail, searchPropParams, pageNumber) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.searchAvailPropList)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async searchSelectPropList(userDetail, searchPropParams, pageNumber) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.updateSelPropList)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async resetRegionList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.resetRegions)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async resetBrandList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.resetBrands)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async resetFranchiseList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.resetFranchises)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async updateBrandList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.updateBrands)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async updateRegionList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.updateRegions)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async updateFranchiseList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.updateFranchise)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async updateAll(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.updateAllProperties)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async getHotelUserEditCopy(params) {
    let res = await axios.get(
      Utils.getAPIURI(Settings.api.editHotelUser.userEditCopy),
      {
  ...
  async getCopySearchData(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.searchUserEditCopy)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async updateCopySearchData(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.searchUserEditUpdate)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
  ...
  async populatePropList(data) {
    ...
    let res = await axios.post(
      `${Utils.getAPIURI(Settings.api.editHotelUser.populatePropertyList)}`,
      postData,
      {
        headers: {
          "Content-Type": Settings.api.urlencode,
