...
import PeriodMaintenanceContext from "../context/PeriodMaintenanceContext";
import Settings from "../static/Settings";
import UpdateBtnImg from "../../../../common/assets/img/btnUpdate.gif";
import styles from "./EditPeriod.css";
...
export default class EditPeriodMaintenance extends Component<IProps, IState> {
