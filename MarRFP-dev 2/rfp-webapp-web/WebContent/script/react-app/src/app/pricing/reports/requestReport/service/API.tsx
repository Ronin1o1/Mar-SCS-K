...
const API = {
  ...
  async showFilterOptions() {
    let res = await axios.get(Utils.getAPIURI(Settings.api.getRequestReportFilter), {
      headers: {
        Pragma: Settings.noCache,
      }
    });
    API.handleErrorResponse(res, Utils.getAPIURI(Settings.api.getRequestReportFilter));
    return res.data;
  },

  async getPricingFilter() {

    let res = await axios.get(Utils.getAPIURI(Settings.api.getRequestReportFindFilter), {
      headers: {
        Pragma: Settings.noCache,
      }
    });
    API.handleErrorResponse(res, Utils.getAPIURI(Settings.api.getRequestReportFindFilter));
    return res.data;
  ...
  async getFilteredHotelList(data) {
    ...
    //   "accountFilter": (data.strFilterValues.accountFilter.accountstatus == "ALL") ? { "accountstatus": data.strFilterValues.accountFilter.accountstatus } : data.strFilterValues.accountFilter,
    ...
    const res = await axios.post(Utils.getAPIURI(Settings.api.getFilteredHotelList), postData, {
      headers: {
    ...
    API.handleErrorResponse(res, Utils.getAPIURI(Settings.api.getFilteredHotelList));
  ...
  async getRunReport(strHotelList, data) {
    ...
    //   "highlightedOnly":  data.strFilterValues.highlightedOnly,
    //   "emailMe":  data.strFilterValues.emailMe,
    //   "report": data.strFilterValues.report,
    // };
    ...
    const res = await axios.post(Utils.getAPIURI(Settings.api.runReport), postData, {
      headers: {
        "Content-Type": Settings.urlencode,
      },
    });
