...
export default class CopyText extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      selectedOption: sessionStorage.getItem("radioBtnchecked-RD")
        ? sessionStorage.getItem("radioBtnchecked-RD")
        : "noAction",
    };
  }
  ...
  handleClick = () => {
    let path = "/roomdeftext/roomDescription";
    ...
    if (action === "empty" || action === "copyData") {
      if (action === "copyData") {
        ...
        if (!channelList.channelName) {
          ...
          path = `/roomdeftext/dataElements?languageCode=${channelList.languageCode}&languageName=${channelList.languageName}
                    &channelCode=${channelList.channelCode}&channelNumber=${channelList.channelNumber}
                     &channelName=${channelList.channelName}&createNew=true`;
          const req = {
        ...
        path = `/roomdeftext/dataElements?languageCode=${queryParam.languageCode}
  ...
  handleOptionChange = (changeEvent) => {
    ...
    sessionStorage.setItem("radioBtnchecked-RD", changeEvent.target.value);
  };
