...
export default class RateProduct extends React.Component {
  ...
  handleNext(event) {
    ...
    if (event.target.value === "copy-new") {
      this.setState({
        copyNew: event.target.value,
      });
    }
    if (event.target.value === "copy-values") {
      this.setState({
        copyValues: event.target.value,
      });
    }
  }
  ...
  nextFunction_new(event) {
    if (contextType.createNewRules) {
      this.props.history.push({
        pathname: "/roomtypenamerules/formattedRoomView",
        state: {
      ...
      if (this.state.channelValue === null) {
        ...
        const param = {
          ...
          strChannel: JSON.stringify(this.props.location.state.strChannel),
          strEntry: JSON.stringify(this.props.location.state.strEntry),
        };
        this.props.history.push({
          pathname: "/roomtypenamerules/formattedRoomView",
          state: {
                  ...
                  <tbody>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td className={styles.fieldValue}>
                                ...
                                >
                                  <option>
                                    {Settings.roomDescriptionTitles.pleaseEntry}
                                  </option>
                    ...
                    <tr>
                      <td className={styles.nextbtn}>
                        ...
                        >
                          <img tabIndex={0} src={nextBtnImg} alt={"nextbtn"} />
                        </p>
                      </td>
                    </tr>
                  </tbody>
