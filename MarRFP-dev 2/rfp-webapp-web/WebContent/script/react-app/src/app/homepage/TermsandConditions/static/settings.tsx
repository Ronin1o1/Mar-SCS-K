const Settings = {
  ...
  //     protectionOfExistingAgreementsContent:"Except as set forth in these terms and conditions, neither your access to MarRFP nor your use of its content shall be construed to establish any new contractual or other commitment of any kind on behalf of Marriott, or to alter or amend any existing contractual or other commitment that exists between your company and Marriott or a Marriott affiliate.",
  //     trademarks:"7. Trademarks.",
  //     trademarksContent:"Marriott, MarRFP, and the other trade names, trademarks, and service marks of Marriott are the exclusive property of Marriott, and no use thereof is permitted without Marriott's express prior written consent.",
  ...
  //     bTBookingCostContent2:"  symbol can be used to identify which MarRFP accounts are eligible for the BT Booking Cost. For the comprehensive program details, including billing criteria, access MGS and search for BT Booking Cost.",
  //     disputes:"9. Disputes.",
  //     disputesContent1:"These terms and conditions will be interpreted in accordance with the laws of the state of Maryland, without regard to its conflicts of laws principles. You hereby consent to the exclusive jurisdiction of state and federal courts located in Maryland. You agree that your breach of these terms and conditions will result in irreparable harm to Marriott, and that Marriott is therefore entitled, as a non-exclusive remedy, to obtain injunctive relief in response to a breach of this agreement.",
  //     disputesContent2:"If you become aware of any instance of unauthorized access to MarRFP, or any content, or the misuse of this resource, you should notify the Marriott Business Integrity line at 888-888-9188 to report the incident anonymously. You may also report any such instances via e-mail to",
  //     emailID2:"privacy@marriott.com",
  //     dot:".",
  //     copyrightInfo:"Copyright © 2021 Marriott International. MARRIOTT CONFIDENTIAL AND PROPRIETARY INFORMATION",
  //     btnAccept:"I ACCEPT",
