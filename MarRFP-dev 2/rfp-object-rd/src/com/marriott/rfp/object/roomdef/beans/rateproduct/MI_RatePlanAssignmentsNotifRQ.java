...
public class MI_RatePlanAssignmentsNotifRQ implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public MI_RatePlanAssignmentsNotifRQ() {
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MI_RatePlanAssignmentsNotifRQ))
			return false;
		MI_RatePlanAssignmentsNotifRQ other = (MI_RatePlanAssignmentsNotifRQ) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_RatePlanAssignmentsNotifRQ.class);
	...
	static {
		...
		ele.setXmlName(new javax.xml.namespace.QName("", "RatePlanAssignmentList"));
		ele.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "RatePlanAssignmentList"));
	       ele.setMinOccurs(0);
	        ele.setNillable(false);
		typeDesc.addFieldDesc(ele);
