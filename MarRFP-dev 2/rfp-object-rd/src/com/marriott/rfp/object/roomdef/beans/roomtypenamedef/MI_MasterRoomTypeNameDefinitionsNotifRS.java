...
public class MI_MasterRoomTypeNameDefinitionsNotifRS implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public MI_MasterRoomTypeNameDefinitionsNotifRS() {
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MI_MasterRoomTypeNameDefinitionsNotifRS))
			return false;
		MI_MasterRoomTypeNameDefinitionsNotifRS other = (MI_MasterRoomTypeNameDefinitionsNotifRS) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals =
			true
				...
				&& ((RoomTypes == null && other.getRoomTypes() == null) || (RoomTypes != null && RoomTypes.equals(other.getRoomTypes())))
	...
	public synchronized int hashCode() {
		...
		if (getRoomTypes() != null) {
			_hashCode += getRoomTypes().hashCode();
		}
		if (getErrors() != null) {
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_MasterRoomTypeNameDefinitionsNotifRS.class);
	...
	static {
		...
		typeDesc.addFieldDesc(field);
		field = new org.apache.axis.description.ElementDesc();
		field.setFieldName("roomTypes");
		field.setXmlName(new javax.xml.namespace.QName("", "RoomTypes"));
		field.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "RoomTypes"));
		typeDesc.addFieldDesc(field);
		field = new org.apache.axis.description.ElementDesc();
	 ...
	 * @param types
	 */
	public void setRoomTypes(RoomTypes types) {
		RoomTypes = types;
	}
