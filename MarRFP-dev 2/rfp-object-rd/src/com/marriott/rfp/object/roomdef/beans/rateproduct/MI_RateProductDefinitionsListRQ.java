...
public class MI_RateProductDefinitionsListRQ implements java.io.Serializable {
    /**
	 * 
	 */
    ...
    private RateProductDefinitionsSearch rateProductDefinitionsSearch;

    public MI_RateProductDefinitionsListRQ() {
    }
	...
	public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MI_RateProductDefinitionsListRQ))
            return false;
        MI_RateProductDefinitionsListRQ other = (MI_RateProductDefinitionsListRQ) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
        ...
        _equals = true
                ...
                && ((rateProductDefinitionsSearch == null && other.getRateProductDefinitionsSearch() == null) || (rateProductDefinitionsSearch != null && rateProductDefinitionsSearch
                        .equals(other.getRateProductDefinitionsSearch())))
	...
	public synchronized int hashCode() {
        ...
        if (getRateProductDefinitionsSearch() != null) {
            _hashCode += getRateProductDefinitionsSearch().hashCode();
        }
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_RateProductDefinitionsListRQ.class);
    ...
    static {
        ...
        ele = new org.apache.axis.description.ElementDesc();
        ele.setFieldName("rateProductDefinitionsSearch");
        ele.setXmlName(new javax.xml.namespace.QName("", "RateProductDefinitionsSearch"));
        ele.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "RateProductDefinitionsSearch"));
        ele.setMinOccurs(0);
        ele.setNillable(false);
        typeDesc.addFieldDesc(ele);
     ...
     * @return
     */
    public RateProductDefinitionsSearch getRateProductDefinitionsSearch() {
        return rateProductDefinitionsSearch;
    }

    /**
     * @param types
     */
    public void setRateProductDefinitionsSearch(RateProductDefinitionsSearch rateProductDefinitionsSearch) {
        this.rateProductDefinitionsSearch = rateProductDefinitionsSearch;
    }
