...
public class MI_RateProductDefinitionsListRS implements java.io.Serializable {
	/**
	 * 
	 */
	...
	private String timeStamp; //attribute
	private String target; //attribute
	private String primaryLandID; //attribute
	private BasicPropertyInfo basicPropertyInfo;
	private RateProductDefinitionsList rateProductDefinitionsList;
	private Errors errors;

	public MI_RateProductDefinitionsListRS() {
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MI_RateProductDefinitionsListRS))
			return false;
		MI_RateProductDefinitionsListRS other = (MI_RateProductDefinitionsListRS) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals =
			true
				...
				&& ((target == null && other.getTarget() == null) || (target != null && target.equals(other.getTarget())))
				&& ((timeStamp == null && other.getTimeStamp() == null) || (timeStamp != null && timeStamp.equals(other.getTimeStamp())))
				&& ((primaryLandID == null && other.getPrimaryLandID() == null) || (primaryLandID != null && primaryLandID.equals(other.getPrimaryLandID())))
				...
				&& ((rateProductDefinitionsList == null && other.getRateProductDefinitionsList() == null) || (rateProductDefinitionsList != null && rateProductDefinitionsList.equals(other.getRateProductDefinitionsList())))
	...
	public synchronized int hashCode() {
		...
		if (getPrimaryLandID() != null) {
			_hashCode += getPrimaryLandID().hashCode();
		}
		if (getBasicPropertyInfo() != null) {
			_hashCode += getBasicPropertyInfo().hashCode();
		}
		if (getRateProductDefinitionsList() != null) {
			_hashCode += getRateProductDefinitionsList().hashCode();
		}
		if (getErrors() != null) {
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_RateProductDefinitionsListRS.class);
	...
	static {
		...
		field = new org.apache.axis.description.AttributeDesc();
		field.setFieldName("target");
		field.setXmlName(new javax.xml.namespace.QName("", "Target"));
		field.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		typeDesc.addFieldDesc(field);

		field = new org.apache.axis.description.AttributeDesc();
		field.setFieldName("timeStamp");
		field.setXmlName(new javax.xml.namespace.QName("", "TimeStamp"));
		field.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		typeDesc.addFieldDesc(field);
		...
		field = new org.apache.axis.description.ElementDesc();
		field.setFieldName("rateProductDefinitionsList");
		field.setXmlName(new javax.xml.namespace.QName("", "RateProductDefinitionsList"));
		field.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "RateProductDefinitionsList"));
		typeDesc.addFieldDesc(field);
	 ...
	 * @return
	 */
	public RateProductDefinitionsList getRateProductDefinitionsList() {
		return rateProductDefinitionsList;
	}

	/**
	 * @param types
	 */
	public void setRateProductDefinitionsList(RateProductDefinitionsList rateProductDefinitionsList) {
		this.rateProductDefinitionsList = rateProductDefinitionsList;
	}
    ...
    /**
     * @return Returns the primaryLandID.
     */
    public String getPrimaryLandID() {
        return primaryLandID;
    }
    /**
     * @param primaryLandID The primaryLandID to set.
     */
    public void setPrimaryLandID(String primaryLandID) {
        this.primaryLandID = primaryLandID;
    }
    /**
