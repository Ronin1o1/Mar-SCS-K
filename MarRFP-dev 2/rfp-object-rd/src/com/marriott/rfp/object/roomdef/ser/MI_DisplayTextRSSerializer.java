...
public class MI_DisplayTextRSSerializer implements SimpleValueSerializer {
	 ...
	 */
	    ...
	    public MI_DisplayTextRSSerializer(Class javaType, QName xmlType) {
	        this.xmlType = xmlType;
	        this.javaType = javaType;
	        init();
	    }
	    public MI_DisplayTextRSSerializer(Class javaType, QName xmlType, TypeDesc typeDesc) {
	        this.xmlType = xmlType;
	        this.javaType = javaType;
	    ...
	    */
	        ...
	        throws IOException
	    {
	        ...
	        if (valueStr != null) {
	        	chgStr = replaceChars(valueStr);
	            context.writeString(chgStr);
	        }
	        context.endElement();
	    }
	            ...
	            if (!propName.equals("value")) {
	                if (typeDesc != null) {
	                    ...
	                    if (field != null) {
	                        ...
	                        // write attribute element
	                        //  the attribute name needs to be preserved from the XML
