...
public class MI_RatePlanAssignmentListRQ implements java.io.Serializable {
    /**
	 * 
	 */
    ...
    public MI_RatePlanAssignmentListRQ() {
    }
	...
	public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MI_RatePlanAssignmentListRQ))
            return false;
        MI_RatePlanAssignmentListRQ other = (MI_RatePlanAssignmentListRQ) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
        ...
        _equals = true
                ...
                && ((ratePlanAssignmentsSearch == null && other.getRatePlanAssignmentsSearch() == null) || (ratePlanAssignmentsSearch != null && ratePlanAssignmentsSearch
                        .equals(other.getRatePlanAssignmentsSearch())))
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_RatePlanAssignmentListRQ.class);
    ...
    static {
        ...
        ele = new org.apache.axis.description.ElementDesc();
        ele.setFieldName("ratePlanAssignmentsSearch");
        ele.setXmlName(new javax.xml.namespace.QName("", "RatePlanAssignmentsSearch"));
        ele.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "RatePlanAssignmentsSearch"));
        ele.setMinOccurs(0);
        ele.setNillable(false);
        typeDesc.addFieldDesc(ele);
    ...
    /**
     * @param ratePlanAssignmentsSearch
     *                   The ratePlanAssignmentsSearch to set.
     */
