...
public class OTA_HotelInvCountRQ implements java.io.Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private java.lang.Object POS;
	private java.lang.Object inventories;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof OTA_HotelInvCountRQ))
			return false;
		OTA_HotelInvCountRQ other = (OTA_HotelInvCountRQ) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals =
			true
				...
				&& ((inventories == null && other.getInventories() == null) || (inventories != null && inventories.equals(other.getInventories())))
	...
	public synchronized int hashCode() {
		...
		if (getInventories() != null) {
			_hashCode += getInventories().hashCode();
		}
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(OTA_HotelInvCountRQ.class);
	...
	static {
		...
		ele.setFieldName("inventories");
		ele.setXmlName(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "Inventories"));
	...
	public java.lang.Object getInventories() {
	    return inventories;
	}

	public void setInventories(java.lang.Object inventories) {
