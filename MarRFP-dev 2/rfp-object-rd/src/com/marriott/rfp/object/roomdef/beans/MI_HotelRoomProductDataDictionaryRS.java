...
public class MI_HotelRoomProductDataDictionaryRS implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public MI_HotelRoomProductDataDictionaryRS() {
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MI_HotelRoomProductDataDictionaryRS))
			return false;
		MI_HotelRoomProductDataDictionaryRS other = (MI_HotelRoomProductDataDictionaryRS) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals =
			true
				...
				&& ((dataDictionary == null && other.getDataDictionary() == null) || (dataDictionary != null && dataDictionary.equals(other.getDataDictionary())))
	...
	public synchronized int hashCode() {
		...
		if (getDataDictionary() != null) {
			_hashCode += getDataDictionary().hashCode();
		}
		if (getErrors() != null) {
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_HotelRoomProductDataDictionaryRS.class);
	...
	static {
		...
		typeDesc.addFieldDesc(field);
		field = new org.apache.axis.description.ElementDesc();
		field.setFieldName("dataDictionary");
		field.setXmlName(new javax.xml.namespace.QName("", "DataDictionary"));
		field.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "DataDictionary"));
		typeDesc.addFieldDesc(field);
		field = new org.apache.axis.description.ElementDesc();
	 ...
	 * @param types
	 */
	public void setDataDictionary(DataDictionary types) {
