...
public class MI_RateProductDefinitionsNotifRS implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public MI_RateProductDefinitionsNotifRS() {
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MI_RateProductDefinitionsNotifRS))
			return false;
		MI_RateProductDefinitionsNotifRS other = (MI_RateProductDefinitionsNotifRS) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals =
			true
				...
				&& ((rateProductDefinitions == null && other.getRateProductDefinitions() == null) || (rateProductDefinitions != null && rateProductDefinitions.equals(other.getRateProductDefinitions())))
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_RateProductDefinitionsNotifRS.class);
	...
	static {
		...
		field.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "RateProductDefinitions"));
		typeDesc.addFieldDesc(field);
		field = new org.apache.axis.description.ElementDesc();
	 ...
	 * @param types
	 */
	public void setRateProductDefinitions(RateProductDefinitions rateProductDefinitions) {
		this.rateProductDefinitions = rateProductDefinitions;
	}
