...
public class OTA_HotelInvCountRS implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof OTA_HotelInvCountRS))
			return false;
		OTA_HotelInvCountRS other = (OTA_HotelInvCountRS) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals = true
				...
				&& ((inventories == null && other.getInventories() == null) || (inventories != null && inventories
						.equals(other.getInventories())))
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(OTA_HotelInvCountRS.class);
