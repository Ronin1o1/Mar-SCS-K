...
public class MI_HotelRoomProductInfoChannelLanguagesRS implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public MI_HotelRoomProductInfoChannelLanguagesRS() {
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MI_HotelRoomProductInfoChannelLanguagesRS))
			return false;
		MI_HotelRoomProductInfoChannelLanguagesRS other = (MI_HotelRoomProductInfoChannelLanguagesRS) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_HotelRoomProductInfoChannelLanguagesRS.class);
	...
	static {
		...
		typeDesc.addFieldDesc(field);
		field = new org.apache.axis.description.ElementDesc();
		field.setFieldName("channels");
		field.setXmlName(new javax.xml.namespace.QName("", "Channels"));
		//field.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "Channels"));
		typeDesc.addFieldDesc(field);
