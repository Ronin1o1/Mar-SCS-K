...
public class MI_HotelRateCodeListRS implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MI_HotelRateCodeListRS))
			return false;
		MI_HotelRateCodeListRS other = (MI_HotelRateCodeListRS) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
		...
		_equals =
			true
				...
				&& ((RatePlans == null && other.getRatePlans() == null) || (RatePlans != null && RatePlans.equals(other.getRatePlans())))
	...
	public synchronized int hashCode() {
		...
		if (getRatePlans() != null) {
			_hashCode += getRatePlans().hashCode();
		}
		if (getErrors() != null) {
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_HotelRateCodeListRS.class);
	 ...
	 * @param types
	 */
	public void setRatePlans(RatePlans types) {
		RatePlans = types;
	}
