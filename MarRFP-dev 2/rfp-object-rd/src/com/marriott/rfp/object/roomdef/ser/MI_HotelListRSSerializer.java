...
public class MI_HotelListRSSerializer implements Serializer, Serializable {
	...
	protected static Log log =
        LogFactory.getLog(MI_HotelListRSSerializer.class.getName());
    ...
    public MI_HotelListRSSerializer(Class javaType, QName xmlType) {
        this(javaType, xmlType, TypeDesc.getTypeDescForClass(javaType));
    }

    // Construct BeanSerializer for the indicated class/qname
    public MI_HotelListRSSerializer(Class javaType, QName xmlType, TypeDesc typeDesc) {
        ...
        throws IOException
    {
        ...
        boolean suppressElement = (!isEncoded &&
                                  ...
                                  name.getLocalPart().equals("any")) || name.getLocalPart().equals("changed") || name.getLocalPart().equals("dropdownInd") || name.getLocalPart().equals("syncAlert");
        ...
        try {
            ...
            for (int i=0; i<propertyDescriptor.length; i++) {
                ...
                if (propName.equals("class") || propName.equals("productDescriptionEnhanced") || propName.equals("valid"))
                    continue;
                QName qname = null;
                QName xmlType = null;
