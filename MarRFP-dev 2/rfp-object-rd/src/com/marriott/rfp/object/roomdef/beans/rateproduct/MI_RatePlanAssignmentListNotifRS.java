...
import com.marriott.rfp.object.roomdef.beans.RatePlanAssignmentNotify;
import com.marriott.rfp.object.roomdef.ser.MI_HotelListRSDeserializer;


public class MI_RatePlanAssignmentListNotifRS implements java.io.Serializable {
    /**
	 * 
	 */
    ...
    private RatePlanAssignmentNotify ratePlanAssignmentNotify;
    private Errors errors;

    public MI_RatePlanAssignmentListNotifRS() {
    }
	...
	public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MI_RatePlanAssignmentListNotifRS))
            return false;
        MI_RatePlanAssignmentListNotifRS other = (MI_RatePlanAssignmentListNotifRS) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
        ...
        _equals = true
                ...
                && ((ratePlanAssignmentNotify == null && other.getRatePlanAssignmentNotify() == null) || (ratePlanAssignmentNotify != null && ratePlanAssignmentNotify.equals(other.getRatePlanAssignmentNotify())))
	...
	public synchronized int hashCode() {
        ...
        if (getRatePlanAssignmentNotify() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getRatePlanAssignmentNotify()); i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getRatePlanAssignmentNotify(), i);
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MI_RatePlanAssignmentListNotifRS.class);
    ...
    static {
        ...
        field = new org.apache.axis.description.ElementDesc();
        field.setFieldName("ratePlanAssignmentNotify");
        field.setXmlName(new javax.xml.namespace.QName("", "RatePlanAssignmentNotify"));
        field.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "RatePlanAssignmentNotify"));
        typeDesc.addFieldDesc(field);
     ...
     */
    public RatePlanAssignmentNotify getRatePlanAssignmentNotify() {
        return ratePlanAssignmentNotify;
    }
     ...
     */
    public void setRatePlanAssignmentNotify(RatePlanAssignmentNotify ratePlanAssignmentNotify) {
        this.ratePlanAssignmentNotify = ratePlanAssignmentNotify;
    }
