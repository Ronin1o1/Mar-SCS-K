...
public class UserCleanupLoad {
	...
	public static  final String LOAD_CREATE_USER  = "USERCLEANUP_BATCH";
	...
	public UserCleanupLoad(){}
	
	public UserCleanupLoad(BigDecimal batchId, String status, String loadType, Date loadStart, Date loadEnd, String loadCreateUser, String loadEndUser) {
