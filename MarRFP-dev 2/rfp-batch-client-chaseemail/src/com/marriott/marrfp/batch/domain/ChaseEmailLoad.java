...
public class ChaseEmailLoad {
	...
	public static  final String LOAD_CREATE_USER  = "CHASEEMAIL_BATCH";
	...
	public ChaseEmailLoad(){}
	
	public ChaseEmailLoad(BigDecimal batchId, String status, String loadType, Date loadStart, Date loadEnd, String loadCreateUser, String loadEndUser) {
